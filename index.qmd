...
=======
$$
>>>>>>> parent of 2868fcc (still working on derivations)
\begin{aligned}
...
\color{green}[(A-\widehat{A})^{\prime} X^{\prime} X(A-\widehat{A})+(A-\underline{A})^{\prime} \underline{V}^{-1}(A-\underline{A})\right.\right.\right. \\
...
\color{red}{+ Y^\prime Y-Y^\prime X \widehat{A} - \widehat{A}^\prime X^\prime Y + \widehat{A}^\prime X^\prime X \widehat{A}}+ \underline{S}\\
...
\color{red}{+ Y^\prime Y}+ \underline{S} \color{green}{+ \underline{A}^\prime \underline{V}^{-1} \underline{A}}\\
...
$$
\begin{aligned}
& = A^\prime \color{green}{\overline{V}^{-1}}A -2A^\prime \color{green}{\overline{V}^{-1}\overline{V}} (X^\prime Y+\underline{V}^{-1} \underline{A}) + Y^\prime Y+ \underline{S} + \underline{A}^\prime \underline{V}^{-1} \underline{A}
\end{aligned}
$$
...
$$
\begin{aligned}
\exp \left\{-\frac{1}{2} \operatorname{tr}\left[\Sigma^{-1}(A-\overline{A})^{\prime} \overline{V}^{-1}(A-\overline{A})\right]\right\}\exp \left\{-\frac{1}{2} \operatorname{tr}\left[\Sigma^{-1}\overline{S}}
\end{aligned}
$$
$$
\begin{aligned}
...
$$
#### The posterior distribution
In this section, we will derive the full-conditional posterior distribution of $\kappa$ and the joint full-conditional posterior distribution of $A$ and $\Sigma$.

##### The derivations of the joint full-conditional posterior distribution of $A$ abd $\Sigma$
$$
\begin{aligned}
...
\color{green}[(A-\widehat{A})^{\prime} X^{\prime} X(A-\widehat{A})+(A-\underline{A})^{\prime} \frac{1}{\kappa} \underline{V}^{-1}(A-\underline{A})\right.\right.\right. \\
&\left.\left.\left.+(Y-X \widehat{A})^{\prime}(Y-X \widehat{A})+\underline{S}\right]\right]\right\}
\end{aligned}
$$
$$
