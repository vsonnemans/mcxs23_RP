...
$$
\begin{aligned}
\exp\left\{-\frac{1}{2}tr[\Sigma^{-1}(A-\overline{A})^{\prime}\overline{V}^{-1}(A-\overline{A})]\right\}
\exp\left\{-\frac{1}{2}tr[\Sigma^{-1}\overline{S}]\right\}
\end{aligned}
$$
$$
\boxed{
...
In this section, we will derive the joint full-conditional posterior distribution of $A$ and $\Sigma$ and the full-conditional posterior distribution of $\kappa$.
